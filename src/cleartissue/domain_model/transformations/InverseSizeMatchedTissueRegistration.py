...
from .utils import build_size_matched_map, PreferredDirection, register_sample_to_atlas_tissue
...
# ================================================================
@dataclass
class InverseSizeMatchedTissueRegistration(AbstractTransformation):
    ...
    def apply(self, batch: SampleBatch) -> SampleBatch:
        ...
        registered_tissue, registered_cells = register_sample_to_atlas_tissue(
