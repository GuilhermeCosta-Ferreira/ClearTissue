...
# 1. Section: Functions
# ================================================================
def register_sample_to_atlas_tissue(
    atlas: Atlas,
    tissue: ClearVolume,
    cells: ClearVolume,
    ...
    for i in tqdm(range(tissue.shape[0]), total=len(atlas_index_map)):
        ...
        atlas_slice = atlas.tissue_template[atlas_idx, :, :]
        ...
        for _ in range(max_retries + 1):
            ...
            warp_result = warp_registrator.register(atlas_slice, affine_result.registered_image)
